...
interface DeliberationsService {
    ...
    @GET("api/records/1.0/search/?dataset=deliberations-tours-metropole-val-de-loire&q=&sort=delib_date&rows=15&facet=delib_id&facet=delib_date&facet=delib_objet&facet=type_seance&facet=themes")
